              ...
              <table width="760" height="200" border="0" align="center" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  <td valign="top" bgcolor="#dee0d5"><table width="720" border="0" align="center" cellpadding="4" cellspacing="0">
                    <tr>
                      <td height="128" valign="top"><img src="images/ss04.jpg" width="160" height="38" /><span class="style4">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br />
                        <?php echo $zhenshi[0]['info'];?></span><br />
                      <a href="device_b_list.php?groupid=1"><span class="style5">&nbsp;&nbsp;&nbsp;　点击查看更多图片</span></a></td>
                    ...
                    <table width="720" border="0" align="center" cellpadding="4" cellspacing="0">
                      <tr>
                        ...
                        <td valign="top"><img src="images/ss05.jpg" width="160" height="38" /><span class="style4"><br />
                            <?php echo $houzhenshi[0]['info'];?></span><br />
                        <a href="device_b_list.php?groupid=2"><span class="style5">&nbsp;&nbsp;&nbsp;　点击查看更多图片</span></a></td>
                      </tr>
                    </table>
                    <table width="720" border="0" align="center" cellpadding="4" cellspacing="0">
                      <tr>
                        <td height="128" valign="top"><img src="images/ss06.jpg" width="160" height="38" /><span class="style4">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br />
                            <?php echo $peixun[0]['info'];?></span><br />
                        <a href="device_b_list.php?groupid=3"><span class="style5">&nbsp;&nbsp;&nbsp;　点击查看更多图片</span></a></td>
                        <td width="300"><img src="<?php echo "./admin/uploadfile/".$peixun[0]['image'];?>" width="300" height="200" /></td>
                      </tr>
                    </table>
                    <br /></td>
                </tr>
