...
//分页列表部分
$query = "SELECT COUNT(*) FROM huodonglist where status<>2 ";
...
$query = "SELECT * FROM huodonglist where status<>2 ORDER BY input_time DESC LIMIT ".$r_start.", ".PAGE_NUM;
                ...
                <tr>
                  <td width="556" valign="top" bgcolor="#dee0d5"><div style="padding-left:25px; padding-top:0px; padding-right:25px; line-height:14px; padding-bottom:30px">
                    <table width="100" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td height="50" valign="bottom" class="style9 style11"><img src="images/j_2.gif" width="125" height="42" /></td>
                      </tr>
                    </table>
					  ...
					  ?>
                        <tr>
                          ...
                          <td width="78%" height="30" background="images/bg1.gif"><a href="activity.php?id=<?php echo $newslist[$i]['id'];?>"><span class="style1"><?php echo $newslist[$i]['title'];?></span></a></td>
